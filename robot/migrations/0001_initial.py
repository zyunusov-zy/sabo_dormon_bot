# Generated by Django 5.2.4 on 2025-07-10 04:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('doctor', 'Врач'), ('accountant', 'Бухгалтер')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('waiting', '⏳ В ожидании'), ('approved_by_doctor', '✅ Одобрено врачом'), ('approved_by_accountant', '✅ Одобрено бухгалтером'), ('fully_approved', '🟢 Полностью одобрено'), ('rejected', '❌ Отклонено')], default='waiting', max_length=30)),
