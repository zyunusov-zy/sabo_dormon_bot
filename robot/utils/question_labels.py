...
QUESTION_FLOW = {
    ...
    "Q6_Region": {
        "label": "Выберите регион проживания или прописки 📍:",
        "options": [
            "Ташкент", "Самарканд", "Фергана", "Андижан", "Бухара", "Хорезм", "Навои",
            "Наманган", "Кашкадарья", "Сурхандарья", "Сырдарья", "Джизак", "Каракалпакстан"
        ],
        "input_type": "buttons",
        "back_button": True
    },
    ...
    "Q22_HousingDoc": {
        "label": "📎 Прикрепите договор аренды или подтверждающий документ.",
        "input_type": "file",
        "back_button": True
    },
    "Q23_Contribution": {
    ...
    "Q24_AdditionalFile": {
        "label": "📎 Прикрепите дополнительный файл, подтверждающий ваши обстоятельства (необязательно).\nЕсли пропускаете — просто отправьте любое сообщение.",
        "input_type": "file_optional",
        "back_button": True
    },
    "Q25_FinalComment": {
        "label": "📝 Есть ли у вас другие важные обстоятельства, которые помогут С-Д принять правильное решение?",
        "input_type": "text",
        "back_button": True
    }
}
